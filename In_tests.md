...
3. Подключить к USB порту Master-платы ПК и открыть терминал для обмена командами по UART
4. Перед подачей питания потренироваться вращать ручку изменения напряжения в заданных пределах (22-26В)
5. Подать питание 24В на материнскую плату; на управляющей плате LED1 должен мигать раз в секунду
6. Последить за сборкой в течение 60 сек
7. Плавно изменять уровень напряжения в диапазоне 22-26В на протяжении 60 сек
8. Наблюдать, изменилось ли поведение в сравнении с предыдущей итерацией (субъективные ощущения: быстрее\медленнее, ярче\тусклее etc)
9. Снять питание
10. Посмотреть на плату через тепловизор (пометить на файле приложения наиболее горячие компоненты)
11. Выставить напряжение 18В
12. Подать питание на материнскую плату
13. Наблюдать, изменилось ли поведение в сравнении с предыдущей итерацией (субъективные ощущения: быстрее\медленнее, ярче\тусклее etc). Запустилось ли вообще. 
14. Снять питание
15. Посмотреть на плату через тепловизор (пометить на файле приложения наиболее горячие компоненты)
16. Выставить напряжение 30В
17. Подать питание на материнскую плату
18. Если ничего не вспыхнуло и не задымилось - ожидать 60 сек, иначе снять питание сразу
19. Мультиметром замерить напряжение после предохранителей F1 и F2 (должно быть 0V)
20. Снять питание
21. Посмотреть на плату через тепловизор (пометить на файле приложения наиболее горячие компоненты)
22. Мультиметром в режиме прозвонки убедиться, что предохранители F1 и F2 перегорели
23. Вставить новые предохранители на 5А
24. Выставить напряжение на ИП 24В
25. Подать питание на материнскую плату
26. Последить за сборкой в течение 60 сек
27. Снять питание
28. Посмотреть на плату через тепловизор (пометить на файле приложения наиболее горячие компоненты)
29. Поменять полярность на источнике питания
30. Подать питание 
31. Если ничего не вспыхнуло и не задымилось - ожидать 60 сек, иначе снять питание сразу
32. Мультиметром замерить напряжение после предохранителей F1 и F2 (должно быть 0V)
33. Снять питание
34. Посмотреть на плату через тепловизор (пометить на файле приложения наиболее горячие компоненты)
