...
4. **Тестирование:**
   - Отправить айдишник платы на следующую за контроллером плату.
...
7. Светодиод на плате начал мерцать - ввести в окне терминала кол-во задействованных плат от 1 до 11. Если в ответ пришло то же самое число, всё ок, если иное - вернуться на шаг 5.

8. Ещё раз убедиться, что все платы, включая плату контроллера размещены на материнской плате ровно и без перекосов, подать питание 24В на материнскую плату.

9. Отправить в окно чата "1", если светодиод мигнул 3 раза - едем дальше, иначе возврат на шаг 5

10. Ожидание инициализации дочерних плат (светодиод плавно загорается и гаснет, макс 60сек)

11. Когда светодиод загорится (будет гореть 10 сек) - первичная инициализация пройдена.
...
13. После завершения тестирования дочерние платы по очереди шлют своё сообщение в шину после того, как увидят сообщение от предыдущей.
