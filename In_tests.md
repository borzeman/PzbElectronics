...
10. Выполнить первичный осмотр плат с использованием тепловизора, отмечая на схеме из приложения к тесту все компоненты, которые нагреваются без подачи нагрузки
11. Отправить команду "s" в UART терминал и сразу же после отправки - извлечь плату контроллера из слота
12. Отключить питание 24В (все последующие фразы "Отключить питание 24В" относятся только к материнской плате, пока не продекларировано обратное)
...
16. Отправить команду "s" в UART терминал, подождать 15 сек и отключить питание 24В
...
20. Отправить команду "s" в UART терминал, подождать 45 сек и отключить питание 24В
...
32. Когда индикаторные светодиоды на платах начнут перемигиваться - отключить питание 24В
...
84. Убедиться, что бит, отвечающий за плату ШД находится в состоянии сработки
85. Отпустить концевик
86. Убедиться, что биты, отвечающие за плату ШД и дискретную плату находится в открытом состоянии
...
121. Ослабить 2 провода +24В: силовой и логический
