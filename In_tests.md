...
22. Подать питание 24В
23. LED1 на мастер плате должен мигать 10 раз в секунду; проверять не менее 10 секунд
24. Отключить питание
25. Проверить состояние компонентов плат (пирометром\тепловизором) - схема компонентов в графическом виде приведёна в приложении 1. Если компонент нагрет выше 50°C, пометить его на схеме.
